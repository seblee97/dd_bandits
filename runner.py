...
class Runner(base_runner.BaseRunner):
    def __init__(self, config, unique_id: str):
        self._estimator_group = [
            utils.EstimatorGroup(config.learning_rate, config.n_ensemble)
        ...
        self._epsilon_computer = self._setup_epsilon_computer()
        self._lr_computer = self._setup_lr_computer()
    ...
    def _setup_epsilon_computer(self):
        def a():
            return 0.1

        return a

    def _setup_lr_computer(self):
        def a():
            return 0.1
